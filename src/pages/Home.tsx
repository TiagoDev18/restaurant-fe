...
const Home = () => {
  return (
    <div>
      <div className="relative bg-[url('src/assets/wallpaper.jpg')] bg-cover bg-center h-screen flex flex-col text-white">
      ...
      <div
        id="restaurante"
        className="relative bg-[url('src/assets/wallpaperDuo.jpg')] bg-cover bg-center flex items-center min-h-screen text-white"
      >
        <div className="absolute inset-0 bg-black/60"></div>
      ...
      <div
        id="menu"
        className="relative bg-[url('src/assets/wallpaperThree.jpg')] bg-cover bg-center flex min-h-screen text-white"
      >
        <div className="absolute inset-0 bg-black/60"></div>
        <div className="relative z-10 flex flex-col items-center justify-center w-full min-h-screen gap-4">
          ...
          <img className="h-100" src="/src/assets/cardapio.png" />
        </div>
      </div>
